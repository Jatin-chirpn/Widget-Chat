...
export default function AnonymousLogin(props) {
  ...
  return (
    <>
      <div
        className={`bottom-36 shadow-2xl rounded-2xl rounded-t-none right-16 w-[92vw] h-full duration-700 ${props.className}`}
      >
        <Container>
          <div className="h-[34vh] rounded-2xl shadow-inner  rounded-b-none text-center bg-gradient-to-r from-[#0052F1] to-[#003BAF] ">
            <div>
        ...
        <Container>
          <div className="w-[92vw] h-[14vh] bg-white"></div>
        </Container>
        <Container>
          <form
            onSubmit={loginHandler}
            className="h-[34vh] shadow-2xl bg-[#F5F5F5] rounded-2xl absolute left-[15%] top-[25%] w-[60vw] drop-shadow-2xl rounded-b-none py-2"
          >
            ...
            <div className="w-[80%] mt-6 h-[60px] m-auto flex items-center">
              <input
                name="user"
                type="text"
                className="form-control outline-blue-500 w-[85%] h-[80%] px-3 text-base"
                id="exampleFormControlInput5"
                placeholder="Enter Your Name..."
              />
              <button
                type="submit"
                className="px-3 text-blue-600 font-medium rounded-full "
              >
                <svg
        ...
        <Container>
          <div className=" h-[35vh] shadow-inner  w-full rounded-2xl rounded-t-none bg-gradient-to-r from-[#0052F1] to-[#003BAF]"></div>
        </Container>
      </div>
    </>
  );
